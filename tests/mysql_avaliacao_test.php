<?php
    ...
    //teste avaliação banco de dados
    function avaliacao_teste($id, $nota, $comentario, $usuario_id, $post_id) : void
    {
        $dados = ['nota' => $nota, 'comentario' => $comentario];
        $criterio = [['id', '=',  $id], ['usuario_id', '=',  $usuario_id], ['post_id', '=',  $post_id]];
        avalia('usuario',$dados,$criterio);
    }
